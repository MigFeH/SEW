                ...
                if(!isset($_SESSION['tabla1']))
                {
                    echo "<section>
                        ...
                        <form action='#' method='POST' enctype='multipart/form-data'>
                            <label>Seleccione el fichero 'motores_atmosfericos.csv' <input type='file' name='archivo_csv_1' ></label>
                            <p></p>
                            <label>Pulse para importar los datos de la época <input type='submit' value='Importar' name='Cargar_era_1' ></label>
                        </form>
                    </section>";
                }
            ?>
            ...
            <?php
                ...
                if(isset($_SESSION['tabla1']))
                {
                    echo "<section>
                        ...
                        <form action='#' method='POST'>
                            <label>Pulse para exportar los datos de la época <input type='submit' value='Exportar' name='Exportar_era_1'></label>
                        </form>
                    </section>";
                }
            ?>
            ...
            <?php
                ...
                if(!isset($_SESSION['tabla2']))
                {
                    echo "<section>
                        <h4>Importar datos de la época</h4>
                        <form action='#' method='POST' enctype='multipart/form-data'>
                            <label>Seleccione el fichero 'aspiracion_mixta.csv' <input type='file' name='archivo_csv_2' ></label>
                            <p></p>
                            <label>Pulse para importar los datos de la época <input type='submit' value='Importar' name='Cargar_era_2' ></label>
                        </form>
                    </section>";
                }
            ?>
            ...
            <?php
                ...
                if(isset($_SESSION['tabla2']))
                {
                    echo "<section>
                        <h4>Exportar datos de la época</h4>
                        <form action='#' method='POST'>
                            <label>Pulse para exportar los datos de la época <input type='submit' value='Exportar' name='Exportar_era_2'></label>
                        </form>
                    </section>";
                }
            ?>
            ...
            <?php
                ...
                if(!isset($_SESSION['tabla3']))
                {
                    echo "<section>
                        <h4>Importar datos de la época</h4>
                        <form action='#' method='POST' enctype='multipart/form-data'>
                            <label>Seleccione el fichero 'motores_v10_y_v12.csv' <input type='file' name='archivo_csv_3' ></label>
                            <p></p>
                            <label>Pulse para importar los datos de la época <input type='submit' value='Importar' name='Cargar_era_3' ></label>
                        </form>
                    </section>";
                }
            ?>
            ...
            <?php
                ...
                if(isset($_SESSION['tabla3']))
                {
                    echo "<section>
                        <h4>Exportar datos de la época</h4>
                        <form action='#' method='POST'>
                            <label>Pulse para exportar los datos de la época <input type='submit' value='Exportar' name='Exportar_era_3'></label>
                        </form>
                    </section>";
                }
            ?>
            ...
            <?php
                ...
                if(!isset($_SESSION['tabla4']))
                {
                    echo "<section>
                        <h4>Importar datos de la época</h4>
                        <form action='#' method='POST' enctype='multipart/form-data'>
                            <label>Seleccione el fichero 'motores_v8.csv' <input type='file' name='archivo_csv_4' ></label>
                            <p></p>
                            <label>Pulse para importar los datos de la época <input type='submit' value='Importar' name='Cargar_era_4' ></label>
                        </form>
                    </section>";
                }
            ?>
            ...
            <?php
                ...
                if(isset($_SESSION['tabla4']))
                {
                    echo "<section>
                        <h4>Exportar datos de la época</h4>
                        <form action='#' method='POST'>
                            <label>Pulse para exportar los datos de la época <input type='submit' value='Exportar' name='Exportar_era_4'></label>
                        </form>
                    </section>";
                }
            ?>
            ...
            <?php
                ...
                if(!isset($_SESSION['tabla5']))
                {
                    echo "<section>
                            <h4>Importar datos de la época</h4>
                            <form action='#' method='POST' enctype='multipart/form-data'>
                                <label>Seleccione el fichero 'motores_hibridos.csv' <input type='file' name='archivo_csv_5' ></label>
                                <p></p>
                                <label>Pulse para importar los datos de la época <input type='submit' value='Importar' name='Cargar_era_5' ></label>
                            </form>
                        </section>";
                }
            ?>
            ...
            <?php
                ...
                if(isset($_SESSION['tabla5']))
                {
                    echo "<section>
                            <h4>Exportar datos de la época</h4>
                            <form action='#' method='POST'>
                                <label>Pulse para exportar los datos de la época <input type='submit' value='Exportar' name='Exportar_era_5'></label>
                            </form>
                        </section>";
                }
            ?>
